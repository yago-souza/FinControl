...
const faturaService = `package com.fincontrol.backend.service;
...
const faturaController = `package com.fincontrol.backend.controller;
...
writeJavaFile('service/FaturaService.java', faturaService);
writeJavaFile('controller/FaturaController.java', faturaController);
