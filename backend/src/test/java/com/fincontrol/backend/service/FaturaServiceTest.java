...
public class FaturaServiceTest {
    ...
    @Test
    void testDeleteLancamentoPropagaParaFuturos() {
        Cartao cartao = new Cartao();
        cartao.setId(1L);
        cartao.setUser(user);
        ...
        faturaService.deleteLancamento(100L, user);

        verify(lancamentoRepository).delete(lJun);
        verify(lancamentoRepository).delete(lJul);
    }
}
