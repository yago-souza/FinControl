...
const dashboardController = `package com.fincontrol.backend.controller;
...
const dashboardService = `package com.fincontrol.backend.service;
...
writeJavaFile('controller/DashboardController.java', dashboardController);
writeJavaFile('service/DashboardService.java', dashboardService);
